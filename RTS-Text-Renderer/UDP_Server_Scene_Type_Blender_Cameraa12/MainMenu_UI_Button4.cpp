...
void push_vertex_mainmenu_button4(std::vector<float>& vertices, float x, float y, float z, float u, float v, float vvtype) {
...
MainMenuUIButton4::MainMenuUIButton4()
{
...
int MainMenuUIButton4::CreateMainMenuQuads()
{
	float vvtype = 111.0f;
	...
	for (int i = 0; i < 4; i++)
	{
		...
		push_vertex_mainmenu_button4(mainVertices, fEndX, fStartY, z, 1.0f, 1.0f, vvtype); // bottom-left screen position, new bottom-left UVs (from old top-left)
		...
		push_vertex_mainmenu_button4(mainVertices, fEndX, fEndY, z, 1.0f, 0.0f, vvtype); // bottom-right screen position, new bottom-right UVs (from old bottom-left)
		////	mainVertices.push_back(1);

			// Vertex 3: Original top-right screen position. Should get the new top-right UVs.
		push_vertex_mainmenu_button4(mainVertices, fStartX, fEndY, z, 0.0f, 0.0f, vvtype); // top-right screen position, new top-right UVs (from old bottom-right)
		...
		push_vertex_mainmenu_button4(mainVertices, fStartX, fStartY, z, 0.0f, 1.0f, vvtype); // top-left screen position, new top-left UVs (from old top-right)
...
void MainMenuUIButton4::UpdateMainMenu()
{
	/*
...
void MainMenuUIButton4::mouseCallback(GLFWwindow* window, double xpos, double ypos)
{

}
void MainMenuUIButton4::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
MainMenuUIButton4* g_ANA_MainMenuUIButton4;
