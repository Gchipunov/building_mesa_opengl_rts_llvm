...
// vertex animations encoding
// https://www.youtube.com/watch?v=xoLxKinzBwI&t=1s
// https://www.youtube.com/watch?v=cLP6ZKOyClM
// https://www.youtube.com/watch?v=eTBuDbZxwFg&t=31s

// Assuming your mainVertices vector is a vector of floats.
// This is a simplified representation.
void push_vertex_mainmenu_button1(std::vector<float>& vertices, float x, float y, float z, float u, float v, float vvtype) {
...
MainMenuUIButton1::MainMenuUIButton1()
{
...
int MainMenuUIButton1::CreateMainMenuQuads()
{
	float vvtype = 111.0f;
	...
	for (int i = 0; i < 4; i++)
	{
		...
		push_vertex_mainmenu_button1(mainVertices, fEndX, fStartY, z, 1.0f, 1.0f, vvtype); // bottom-left screen position, new bottom-left UVs (from old top-left)
		...
		push_vertex_mainmenu_button1(mainVertices, fEndX, fEndY, z, 1.0f, 0.0f, vvtype); // bottom-right screen position, new bottom-right UVs (from old bottom-left)
		////	mainVertices.push_back(1);

			// Vertex 3: Original top-right screen position. Should get the new top-right UVs.
		push_vertex_mainmenu_button1(mainVertices, fStartX, fEndY, z, 0.0f, 0.0f, vvtype); // top-right screen position, new top-right UVs (from old bottom-right)
		...
		push_vertex_mainmenu_button1(mainVertices, fStartX, fStartY, z, 0.0f, 1.0f, vvtype); // top-left screen position, new top-left UVs (from old top-right)
...
void MainMenuUIButton1::UpdateMainMenu()
{
	/*
...
void MainMenuUIButton1::mouseCallback(GLFWwindow* window, double xpos, double ypos)
{

}
void MainMenuUIButton1::keyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
MainMenuUIButton1* g_ANA_MainMenuUIButton1;
